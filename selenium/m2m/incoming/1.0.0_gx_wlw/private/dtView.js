ss.define(['dtVagueSle'], function(exports) {
	ss.popupState = false;
	var dtView = {
		//弹窗渲染 
							...
							ss.crtDom('div', '', leftVal, dom, {
								...
								.appendDom(function(dom) {									
									...
									if(editViewData[x].type === 'txt') {
										var forbid = editViewData[x].forbid;
										
										var _curInputDom = ss.crtDom('input', '', '', dom, {
											cn: ['width', 'height', 'borderBottom', 'fontSize', 'marginTop'],
											cv: ['100%', '30px', '1px solid #ccc', '14px', '6px'],
											an: [
												'placeholder', 'type', 'name', 'value',forbid?'disabled':null
											],
											av: [
									...
									if(editViewData[x].type === 'select') {	
										...
										var _curSelDom = ss.crtDom('div', '', curEditVal, dom, {
												...
												cv: [
													editViewData[x].width ? editViewData[x].width : '80%', '30px', '30px', '0px 10px', '1px solid #dee4f1', forbid?'#EBEBE4':'#f4f8fa', '#757575', '13px',
