ss.define(function(exports){
    ...
    ss_menu.prototype = {
        ...
        rd_itemsFn:function(){
            ...
            var iconUrls = {
                home:{
                    select:'../assets/images/home_select.png',unselect:'../assets/images/home_unselect.png'
                },
                product:{
                    select:'../assets/images/pm_select.png',unselect:'../assets/images/pm_unselect.png'
                },
                pay:{
                    select:'../assets/images/pay_select.png',unselect:'../assets/images/pay_unselect.png'
                },
                operation:{
                    select:'../assets/images/or_select.png',unselect:'../assets/images/or_unselect.png'
                },
            };
