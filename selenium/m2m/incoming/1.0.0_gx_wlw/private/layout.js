                            ...
                            ss.crtDom('div','ly_header','','',{
                                ...
                                .appendDom(function(dom){
                                    ss.crtDom('img','','',dom,{
                                        ...
                                        an:['src','title'],
                                        av:['./assets/images/sohan_g.png','硕软首页']
                                    },[
                                            'mouseenter',function(dom){
                                                dom.setAttribute('src','./assets/images/sohan.png');
                                            },
                                            'mouseleave',function(dom){
                                                dom.setAttribute('src','./assets/images/sohan_g.png');
                                            },
                                            'click',function(){
                                    ...
                                    //用户显示->(退出|角色切换)
                                    ss.crtDom('span','',obj['userData'] ? obj['userData']['loginNickName']:'管理员',dom,{
                                    ...
                                    .appendDom(function(dom){
	                                    ...
	                                    .appendDom(function(dom){
		                                    ...
		                                    ss.crtDom('p','','退出',dom,{
												cn:['padding','width','overflow','textOverflow','white','height','lineHeight','borderTop','textAlign'],
												cv:['1px 10px','100%','hidden','ellipsis','nowrap','30px','30px','1px solid #ccc','center']
		                                    },[
		                                        'click',function(dom){
